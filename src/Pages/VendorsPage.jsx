...
import { BuildingOfficeIcon, UserIcon, EnvelopeIcon, PhoneIcon, TagIcon, FunnelIcon, MagnifyingGlassIcon, ChevronDownIcon, ChevronUpIcon, MapPinIcon, GlobeAltIcon} from "@heroicons/react/24/outline";
...
const VendorsPage = () => {
  ...
  return (
    <div className=" bg-gradient-to-br from-theme-bg-primary to-theme-bg-secondary dark:from-theme-bg-primary dark:to-theme-bg-secondary py-4 px-4 md:px-10">
      {/* Page Header */}
      <div className="mx-auto">
        {/* max-w-7xl */}
        <Link to="/" className="inline-flex items-center theme-text-secondary hover:theme-text-primary">
        ...
        {/* Controls Section */}
        <div className="mb-2 theme-bg-primary rounded-2xl shadow-xl p-3">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                className="border border-gray-500 theme-bg-secondary rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                value={selectedTag}
          ...
          {/* Results Summary */}
          <div className="mt-1 flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
            <span>
        ...
        {/* Vendors List */}
        {!loading && filteredVendors.length > 0 && (
          <div className="space-y-4 overflow-y-auto max-h-[calc(90vh-200px)] scrollbar-hidden">
            {filteredVendors.map((vendor) => {
              ...
              return (
                <div
                  ...
                  className="theme-bg-secondary rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-500"
                >
                  {/* Vendor Summary */}
                  <div 
                      ...
                      <div className="flex-1">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h2 className="text-xl font-bold theme-text-primary mb-1 truncate">
                              {companyName}
                            </h2>
                            ...
                            {tags.length > 0 && (
                              <div className="flex flex-wrap gap-2 mt-3">
                                {tags.slice(0, 3).map((tag, idx) => (
                                  <span
                                    key={idx}
                                    className="px-3 py-1 rounded-full text-xs font-medium theme-bg-card text-blue-500 dark:text-blue-300 border border-blue-200 dark:border-blue-700"
                                  >
                                    {tag}
                                  </span>
                                ))}
                      ...
                      <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row items-start md:items-end lg:items-start gap-4">
                        <div className="flex flex-col gap-2">
                          {phone && phone !== "null" && (
                            <a
                              href={`tel:${phone}`}
                              className="flex items-center gap-2 theme-text-secondary hover:underline transition text-sm whitespace-nowrap"
                            >
                          ...
                          {email && email !== "null" && (
                            <a
                              href={`mailto:${email}`}
                              className="flex items-center gap-2 theme-text-secondary hover:underline transition text-sm truncate"
                              title={email}
                            >
                        ...
                        {/* Expand Button */}
                        {/* <button
                          className="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full transition ml-auto"
                          onClick={(e) => {
                            e.stopPropagation();
                  ...
                  {/* Expanded Details */}
                  {isExpanded && (
                    <div className="px-3 pb-3 border-t border-gray-500 pt-3 animate-slideDown">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Contact Details */}
                        <div className="space-y-4">
                          <h3 className="font-semibold theme-text-secondary flex items-center gap-2">
                          ...
                          <div className="space-y-3">
                            {contactPerson && contactPerson !== "null" && (
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <p className="text-sm theme-text-primary">Contact Person</p>
                                  <p className="font-medium theme-text-secondary">{contactPerson}</p>
                                </div>
                              </div>
                            )}
                            ...
                            {phone && phone !== "null" && (
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <p className="text-sm theme-text-primary">Phone</p>
                                  <a href={`tel:${phone}`} className="font-medium theme-text-secondary hover:underline transition">
                                    {phone}
                                  </a>
                                </div>
                              </div>
                            ...
                            {email && email !== "null" && (
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <p className="text-sm theme-text-primary">Email</p>
                                  <a href={`mailto:${email}`} className="font-medium theme-text-secondary hover:underline transition truncate block">
                                    {email}
                                  </a>
                                </div>
                              </div>
                          ...
                          <div className="space-y-3">
                            ...
                            {tags.length > 0 && (
                              <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                  <p className="text-sm theme-text-secondary mb-2">Tags & Categories</p>
                                  <div className="flex flex-wrap gap-2">
                                    {tags.map((tag, idx) => (
                                      <span
                                        key={idx}
                                        className="px-3 py-1 rounded-full text-xs font-medium  text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-700"
                                      >
                                        {tag}
                                      </span>
                                    ))}
                      ...
                      {/* Action Buttons */}
                      <div className="mt-3 pt-3 border-t border-gray-500 flex justify-end space-x-4">
                        {phone && phone !== "null" && (
                          <a
                            href={`tel:${phone}`}
                        ...
                        {email && email !== "null" && (
                          <a
                            href={`mailto:${email}`}
                            className="px-5 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-400 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition font-medium flex items-center gap-2"
                          >
                            <EnvelopeIcon className="h-4 w-4" />
                            Send Email
                          </a>
