...
const AddVendorModal = ({ spaceId, projectId, onClose, onAdd }) => {
  // Update form state to match backend expected fields
  const [formData, setFormData] = useState({
    company_name: '',        // Company name instead of vendor_name
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Prepare the request data - use the exact field names backend expects
      const requestData = {
